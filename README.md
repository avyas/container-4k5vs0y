...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-4k5vs0y.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-4k5vs0y.containers.anotherwebservice.com/
...
```
git clone git@github.com:avyas/container-4k5vs0y.git
cd container-4k5vs0y
```
...
```
docker attach container-4k5vs0y
```
